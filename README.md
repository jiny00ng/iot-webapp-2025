# iot-webapp-2025
IoT 개발자 과정 **ASP.NET_Core** 학습 리포지토리

## 1일차 

### Web
- 인터넷 상에 사용되는 서비스 중 하나
- 웹을 표현하는 기술 : HTML(Hyper Text Markup Language). XML(eXtenable Markup Language)의 경량화 버전
- 2014년 이후 HTML5로 적용되고 있음

### 웹 기술
- 웹 표준기술(프론트엔드) : HTML 5(웹 페이지 구조) + CSS 3(디자인) + JavaScript 6(인터렉티브)
...
- 엄청난 발전을 이뤄 여러가지 기술로 분리
    - React.js, View.js 등 프론트엔드 기술 언어로 분파
...
- 스마트팩토리 솔루션을 대부분 웹으로 개발(사용범위 제약을 없애기 위해서)
    ...
    - 전세계 어디서나 사용할 수 있는 회사 스마트팩토리 솔루션을 위해서 웹서비스 + 모바일 + 웹서버 운영
- 스마트홈(IoT), ERP, 병원예약시스템, 호텔예약, 인터넷뱅킹, 온라인서점 ...
...
- html 태크 내 head, body로 구성(무조건!)
- README.MD에도 HTML 태그를 그대로 사용가능(heading은 적용 안됨)
- VS Code에서 자동생성
...
- div CSS로 디자인 적용해서 렌더링속도를 빠르게 변경
- 게시판 목록
