...
namespace MyPortfolioWebApp.Controllers
{
    public class NewsController : Controller
    {
        ...
        // parm int page는 처음 게시판은 무조건 1페이지부터 시작
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            // 쿼리로 처리 가능
            //var news = await _context.News.FromSql($"@SELECT Id, Writer, Title, Description, PostDate, ReadCount FROM News")
            //    .OrderByDescending(o => o.PostDate)
            //    .ToListAsync();
            ...
            var countList = 10; // 한페이지에 기본 뉴스개수 10개
